...
//	Review reviews;
//
//	public ReviewRepositoryold() {
//
//		reviewMap.put(14L, new Review("Window", "images/window.jpg", "Negative-Space", "A single light source with limit throw",
...
//
//		reviewMap.put(12L, new Review("The Boat", "images/boat.jpg", "Negative-Space", "An overcast day allow this boat to stand stark against the water",
...
//
//		reviewMap.put(22L, new Review("Balkan Amemone", "images/balkan-anemone-sm.jpg", "Negative-Space", "Gently bathed in light this flower seems to perice the darkness while remaining intact",
...
//
//		reviewMap.put(32L, new Review("Alone on a Plane", "images/dark-alone-plane.jpg", "Negative-Space", "We can only see light that is moving toward us.",
...
//
//		reviewMap.put(42L, new Review("Men Reflecting", "images/dark-men.jpg", "Negative-Space", "Two men of style reflect on one another other",
